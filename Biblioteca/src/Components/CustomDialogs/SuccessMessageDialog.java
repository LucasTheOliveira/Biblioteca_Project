...
public class SuccessMessageDialog extends JDialog {
    ...
    public SuccessMessageDialog(Component parentComponent, Object message, String title, Color backgroundColor,
    ...
    public static void showMessageDialog(Component parentComponent, Object message, String title, Color backgroundColor,
            Color textColor, Color borderColor, int fontSize) {
        dialog = new SuccessMessageDialog(parentComponent, message, title, backgroundColor, textColor, borderColor, fontSize);
